...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 11 22:20:09 2018
...
pic= io.imread('/home/raja/mod5_assignment/Perfect numbers/2abcd.png', as_grey=True)
pic=255*pic
pic=np.uint8(pic)
io.imshow(pic)
...
for p in properties:
    ...
    #plt.imshow(new)
    z = '/home/raja/mod5_assignment/temp/%s.png' %(str(k))
    imsave(z,new)
