...
raja1= io.imread('/home/raja/Mod 7/test pics/face3.png')
...
finall=np.zeros((3863,6))
finall[0:3256,:]=f1[0:3256,:]

finall[3257:3497,:]=f2[0:240,:]
            
finall[3498:3653,:]=f3[0:155,:]
            
finall[3653:3863,:]=f4[0:210,:]
